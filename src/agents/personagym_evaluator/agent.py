...
initial_state = {
    ...
    # EXPECTED_ACTION
    "expected_action_questions": [],
    "expected_action_persona_responses": [],
    ...
    # LINGUISTIC_HABITS
    "linguistic_habits_questions": [],
    "linguistic_habits_persona_responses": [],
    ...
    "persona_consistentcy_questions": [],
    "persona_consistentcy_persona_responses": [],
    ...
    "action_justification_questions": [],
    "action_justification_persona_responses": [],
...
for task in EvaluationTask:
    ...
    evaluation_task_workflow = SequentialAgent(
        ...
        sub_agents=[
            ...
            create_persona_agent(task=task),
            create_rubric_formatter_agent(task=task),
            create_evaluator_agent(task=task)
        ]
    )
